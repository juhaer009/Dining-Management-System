...
<body>
    <div class="container">
        <div class="discount-container">
            <h3>Notice</h3>
            <hr>
            <form method="post" action="<?php echo e(route('adminNotice')); ?>">
                <?php echo csrf_field(); ?>
                <?php if(Session::has('success')): ?>
                <div class="alert alert-success"><?php echo e(Session::get('success')); ?></div>
                <?php endif; ?>
                <?php if(Session::has('not')): ?>
                <div class="alert alert-danger"><?php echo e(Session::get('not')); ?></div>
                <?php endif; ?>
                <div class="form-group">
                    <label for="notice">Notice</label>
                    <textarea class="form-control" placeholder="" name="notice"></textarea>
                    <div class="form-group">
...
<?php /**PATH /home/saikat/Desktop/oldproject/resources/views/notice.blade.php ENDPATH**/ ?>